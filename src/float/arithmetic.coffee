module.exports = ->
	[
		...
		module.exports.helpers.makeUnary "squareRoot", "float", "float", ((value) -> Math.sqrt(value)), (platform, cache, value) -> "Math.sqrt(" + (module.exports.codeCache platform, cache, value) + ")"
		module.exports.helpers.makeUnary "floor", "float", "float", ((value) -> Math.floor(value)), (platform, cache, value) -> "Math.floor(" + (module.exports.codeCache platform, cache, value) + ")"
		module.exports.helpers.makeUnary "ceiling", "float", "float", ((value) -> Math.ceil(value)), (platform, cache, value) -> "Math.ceil(" + (module.exports.codeCache platform, cache, value) + ")"
	]
