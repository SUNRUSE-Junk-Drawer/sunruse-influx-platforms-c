	...
	describe "javascript", ->
		describe "float", ->
			describe "comparisons", ->
				...
				describe "imports", ->
					it "helpers", ->
						expect(comparisons.helpers).toBe require "sunruse-influx-platforms-helpers"	
					it "codeCache", ->
						expect(comparisons.codeCache).toBe require "./../codeCache"								
				describe "defines", ->
